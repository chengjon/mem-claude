...
**Output:** `~/Scripts/mem-claude/actual_xml_only_with_timestamps.xml`
...
**Output:** `~/Scripts/mem-claude/all_xml_fragments_with_timestamps.xml`
...
Scripts read from: `~/.claude/projects/-Users-alexnewman-Scripts-mem-claude/*.jsonl`
