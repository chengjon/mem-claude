...
<Card title="mem-search.zip" icon="download" href="https://github.com/chengjon/mem-claude/raw/main/plugin/skills/mem-search.zip">
    ...
    ```json
    {
      "mcpServers": {
        "mem-search": {
          "command": "node",
          "args": [
            "/Users/YOUR_USERNAME/.claude/plugins/marketplaces/chengjon/plugin/scripts/mcp-server.cjs"
          ]
        }
      }
    }
    ...
    ```json
    {
      "mcpServers": {
        "mem-search": {
          "command": "node",
          "args": [
            "C:\\Users\\YOUR_USERNAME\\.claude\\plugins\\marketplaces\\chengjon\\plugin\\scripts\\mcp-server.cjs"
          ]
        }
      }
    }
