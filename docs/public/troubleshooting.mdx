...
1. Clear install cache:
   ```bash
   rm ~/.claude/plugins/marketplaces/chengjon/.install-version
   ```
...
3. Check version marker:
   ```bash
   cat ~/.claude/plugins/marketplaces/chengjon/.install-version
   cat ~/.claude/plugins/marketplaces/chengjon/package.json | grep version
   ```
...
3. Check package.json exists:
   ```bash
   ls -la ~/.claude/plugins/marketplaces/chengjon/package.json
   ```
...
2. **Create issue**: [GitHub Issues](https://github.com/chengjon/mem-claude/issues)
